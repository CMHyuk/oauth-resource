...
public class GlobalExceptionController {
    ...
    public ResponseEntity<ApiResponse> BindException(MethodArgumentNotValidException bindException) {
        List<String> defaultMessages = bindException.getBindingResult()
                .getFieldErrors()
                .stream()
